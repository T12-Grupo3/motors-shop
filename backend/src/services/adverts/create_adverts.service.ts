...
const createAdvertsServices = async ({title_adverts, year_adverts, type_adverts, type_veicule, kilometers_adverts, description_adverts, isAvailable, createdAt_adverts, updatedAt_adverts}: IAdverts) =>{
     ...
     newAdverts.type_veicule = type_veicule,
